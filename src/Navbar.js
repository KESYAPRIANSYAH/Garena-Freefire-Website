...
function Navbar() {
  return (
    <nav>
      <div class="bg-black  px-2 sm:px-4 py-2.5  flex flex-wrap justify-between items-center mx-auto fixed-top">
        <a href="https://flowbite.com" class="flex items-center">
          <img src="img/logo5.png" class="ml-10 h-6 sm:h-9" alt="Flowbite Logo" />
        ...
        <div class="flex items-center md:order-2 ">
          ...
          <div class="hidden z-50 my-4 text-base list-none bg-black rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 " id="dropdown">
            ...
            <ul class="py-1" aria-labelledby="dropdown">
              <li>
                <a href="#" class="block py-2 px-4 text-sm text-white hover:bg-gamber-300 dark:hover:bg-amber-300 dark:text-gray-200 dark:hover:text-white">
                  Indonesia
                </a>
              </li>
              <li>
                <a href="#" class="block py-2 px-4 text-sm text-white hover:bg-amber-300 dark:hover:bg-amber-300 dark:text-gray-200 dark:hover:text-white">
                  English
                </a>
              </li>
              <li>
        ...
        <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
          <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
            ...
            <li>
              ...
              <div id="dropdownNavbar" class="z-10 hidden bg-black divide-y divide-gray-100 rounded shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                <ul class="py-1 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                  <li>
                    <a href="/Character" class="block px-4 py-2 hover:bg-amber-300  dark:hover:bg-amber-300 text-white">
                      CHARACTER
                    </a>
                  </li>
                  <li>
                    <a href="/Pet" class="block px-4 py-2 hover:bg-amber-300  dark:hover:bg-amber-300 text-white">
                      PET
                    </a>
                  </li>
                  <li>
                    <a href="/Weapon" class="block px-4 py-2 hover:bg-amber-300  dark:hover:bg-amber-300 text-white">
                      WEAPON
                    </a>
                  </li>
                  <li>
                    <a href="/Maps" class="block px-4 py-2 hover:bg-amber-300 dark:hover:bg-amber300 text-white">
                      MAPS
                    </a>
                  </li>
                </ul>
            ...
            <li>
              ...
              {/* <!-- Dropdown menu --> */}
              <div id="dropdownNavbar2" class="z-10 hidden bg-black divide-y divide-gray-100 rounded shadow w-44 dark:bg-gray-600 dark:divide-gray-600">
                <ul class="py-1 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                  <li>
                    <a href="https://ff.garena.com/universe/en/verify/?redirect=%252Fen%252Fcomic%252F" target="_blank" class="block px-4 py-2 hover:bg-amber-300 dark:hover:bg-amber-300 text-white">
                      COMIC
                    </a>
                  </li>
                  <li>
                    <a href="https://ff.garena.com/universe/en/story/" target="_blank" class="block px-4 py-2 hover:bg-amber-300 dark:hover:bg-amber-300 text-white">
                      STORY
                    </a>
                  </li>
                </ul>
